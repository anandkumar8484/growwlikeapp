...
// NOTE: Removed `next/font/local` usage because Turbopack/Next installation
// in this project could not resolve internal target CSS. If you want to
// load local fonts, add an `@font-face` entry in `app/globals.css` pointing
// at files inside `public/fonts/` (recommended) and then reference the
// font-family in CSS. See instructions below.
